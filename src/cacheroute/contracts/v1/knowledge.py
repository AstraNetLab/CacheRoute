...
__all__ = [
    "KnowledgeDescriptor", "KnowledgeResponse", "RegisterKnowledgeRequest",
    "RegisterKnowledgeResponse", "UpdateKnowledgeRequest", "UpdateKnowledgeResponse",
    "ResolveKnowledgeRequest", "ResolveKnowledgeResponse",
