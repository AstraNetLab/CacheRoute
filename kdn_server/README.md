...
```
python3 batch_register_kdn.py --manifest knowledge_manifest_nq.json --base-url http://127.0.0.1:9101 --api-url http://127.0.0.1:8000/v1/chat/completions --model llama3-70b --redis-host 172.18.0.169 --redis-port 6379 --redis-db 0 --count all --flushdb
```
